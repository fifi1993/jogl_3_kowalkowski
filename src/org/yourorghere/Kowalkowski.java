...
//Czyszczenie przestrzeni 3D przed utworzeniem kolejnej klatki
        ...
        /*float x, y, kat;
         ...
         gl.glTranslatef(0.0f, 0.0f, -3.0f); //przesuni?cie o 6 jednostek
         gl.glBegin(GL.GL_TRIANGLES);
...
y = 1.0f*(float)Math.cos(kat);
gl.glNormal3f(x, 0.0f, 0.0f);
gl.glTexCoord2f(kat/4, 0.0f); gl.glVertex3f(x, 2.0f, y);
gl.glTexCoord2f(kat/4, 1.0f); gl.glVertex3f(x, -2.0f, y);//kolejne punkty
}
gl.glEnd();
